package frc.robot.CANdleLights;
...
public class CANdleSystem extends SubsystemBase {
    ...
    public CANdleSystem(CommandJoystick joystick) {
    ...
    public void periodic() {
        ...
        if(m_toAnimate == null) {
            m_candle.setLEDs((int)(joystick.getX() * 255),
                              (int)(joystick.getY() * 255),
                              (int)(joystick.getThrottle() * 255));
        } else {
            m_candle.animate(m_toAnimate);
        }
        m_candle.modulateVBatOutput(joystick.getRawAxis(4));
    }
